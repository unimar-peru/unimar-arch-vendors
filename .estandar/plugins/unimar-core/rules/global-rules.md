...
| **R-22** | Shells Transversales | Las capacidades transversales que publica [`unimar-shells`](https://github.com/unimar-peru/unimar-shells) —AOP, bootstrapper, DDD, factory— **se usan directamente**: el código hereda de sus tipos y los invoca sin intermediarios. No se envuelven en adaptadores, fachadas ni kernels locales, ni se reimplementan. La capacidad que falte se propone en `unimar-shells`; no se escribe en el Bounded Context. |
