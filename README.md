...
| Pipeline CI/CD                  | Controles de calidad para los pipelines (seguridad local-first)                                                        | F3     | [Enlace](estandar/reference/architecture/adrs/core/0106-seguridad-calidad-local-first.es.md)                                            |                  | ✓        |                |           |              |
