...
| ADR-0049 — Naming y Clean Code | `Cond` | [ADR-0049](../../architecture/adrs/core/0049-politica-naming-semantica-codigo-limpio.es.md) | Pendiente de importación; usar solo como referencia anticipada hasta que ADR-0056 o una política aprobada la superseda formalmente. |
| ADR-0050 — GitFlow Branching | `Cond` | [ADR-0050](../../architecture/adrs/core/0050-estrategia-ramificacion-gitflow.es.md) | Pendiente de importación; aplicar solo cuando el Architecture Board lo apruebe o el repositorio satélite ya lo adopte explícitamente. |
...
| ADR-0033 — Transactional Outbox | `Cond` | [ADR-0033](../../architecture/adrs/core/0033-patron-transactional-outbox.es.md) | Pendiente de importación; requiere revisión del Architecture Board al implementar publicación asíncrona confiable. |
