...
| Infraestructura | [Hub de Infraestructura →](./reference/infrastructure/README.md) | Topología multi-AZ, DR por escenario, componentes (K8s, Kong, Vault, RabbitMQ, Redis, MinIO), herramientas con instalación/uso/licencia | DevOps al aprovisionar entornos; arquitectos al diseñar topología | Centralizar activos de infraestructura cloud |
