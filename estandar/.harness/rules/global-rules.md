...
|---|---|---|
| **R-02** | Context7 | Consultar siempre `context7` para límites de arquitectura en vivo antes de tareas técnicas. |
...
2. Ejecutar `node .harness/scripts/validate-docs.mjs --render-mermaid` cuando hayan cambiado diagramas Mermaid.
3. Corregir enlaces relativos rotos, anclas Markdown faltantes, bloques Mermaid malformados, violaciones de UTF-8 o terminaciones de línea antes del merge.
4. Reportar cualquier anomalía restante explícitamente si no puede corregirse en el mismo cambio.

## Autoridad Heredada

Estas reglas están inspiradas en el corpus de gobernanza upstream de Evolith (<https://github.com/beyondnetcode/evolith_arch32>) y adaptadas para Unimar Arch bajo el modelo open source (no vinculante, voluntario). No son contractuales; Unimar es libre de sobrescribir, simplificar o reemplazar cualquier regla. Diverge deliberadamente, y registra la operación en [`../../DECISIONS.md`](../../DECISIONS.md).
